...
$collection = $client->mongotest->Categories;
$collecCategories = ($collection->find());
$Categories = array();

foreach ($collecCategories as $entry) {
            ...
            <div class="row">
                <div class="col">
                    <div class="header_content d-flex flex-row align-items-center justify-content-start">
                        <div class="logo"><a href="/">Eureka Test.</a></div>
                        <nav class="main_nav">
                            <ul>
                                <li><a href="/">Home</a></li>
                                <li class="hassubs">
                                    ...
                                    <ul>
                                        ...
                                        ?>
                                            <li><a href="products.php?key=<?php echo $key ?>"><?php echo $cat ?> </a></li>
                                        <?php } ?>
                                    </ul>
                                </li>
                                ...
                                if (isset($_SESSION['li_user'])) {
                                    echo "<li>" . $_SESSION['li_user']['user'] . "</li>";?>
                                    <li><a onClick="testClick()" href='redirectLO.php'>Log Out</a></li>
                                    <script>
                                        function testClick() {									
                                            window.tracker.track('logout', {},{"fire": true, asBeacon: true});
                                        }
								    </script>
                                    <?php
                                } else {
    ...
    <div class="menu_container menu_mm">
        <div class="page_menu_content">
            ...
            <ul class="page_menu_nav menu_mm">
                <li class="page_menu_item menu_mm"><a href="/">Home<i class="fa fa-angle-down"></i></a>
                </li>
                <li class="page_menu_item has-children menu_mm">
                    ...
                    <ul class="page_menu_selection menu_mm">
                        ...
                        foreach ($Categories as $key => $cat) {
                        ?>
                            <li class="page_menu_item menu_mm"><a href="products.php?key=<?php echo $key ?>"><?php echo $cat ?><i class="fa fa-angle-down"></i></a></li>
                        <?php } ?>
                    </ul>
                </li>
                ...
                <li class="page_menu_item menu_mm"><a href="login.php">Login<i class="fa fa-angle-down"></i></a></li>
            </ul>
        </div>
    </div>
